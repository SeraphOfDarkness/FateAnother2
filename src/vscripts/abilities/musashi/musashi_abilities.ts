...
import { SkillSlotChecker } from "@tslib/skillslot_checker";
...
export class musashi_modifier_dai_go_sei extends BaseModifier
{
    ...
    {
        const data = {BonusDmg: this.BonusDmg, BonusAtkSpeed: this.BonusAtkSpeed};
        return data;
    }
...
export class musashi_tengan extends BaseAbility
{
    ...
    CanCastTenmaGogan(): void
    {
        //if (this.Caster?.HasModifier(musashi))
        {
            if (this.GetCurrentAbilityCharges() >= this.GetMaxAbilityCharges(1) - 1)
            {
                SkillSlotChecker(this.Caster!, this.GetName(), musashi_tenma_gogan.name, 5);
            }
        }
    }
}
...
//======================================================================================================================
// Miyamoto Musashi: Skill 4: Mukyuu (SA)
//======================================================================================================================
@registerAbility()
...
//======================================================================================================================
// Miyamoto Musashi: Skill 5: Tengen No Hana (SA)
//======================================================================================================================
@registerAbility()
export class musashi_tengen_no_hana extends BaseAbility
{
    override OnSpellStart(): void
    {
        const ModifierTengenNoHana = this.GetCaster()?.FindModifierByName(musashi_modifier_tengen_no_hana.name);
...
export class musashi_modifier_tengen_no_hana extends BaseModifier
{
    ...
    override OnStackCountChanged(stackCount: number): void
    {
        ...
        switch (stackCount)
        {
            case 0:
            {
                this.Damage = this.Ability?.GetSpecialValueFor("Damage1")!;
                break;
            }
            case 1:
            {
                this.Damage = this.Ability?.GetSpecialValueFor("Damage2")!;
                break;
            }
            case 2:
            {
                this.Damage = this.Ability?.GetSpecialValueFor("Damage3")!;
                this.Destroy();
                break;
            }
        }
    ...
    CreateParticle(): void
    {
        if (this.Caster?.HasModifier("modifier_ascended"))
        {
            ...
            {
                this.OverheadParticleStr = "particles/custom/musashi/musashi_tengen_no_hana_unique2.vpcf";
            }
        }
    ...
    CreateAoeParticle(): void
    {
        if (this.Caster?.HasModifier("modifier_ascended"))
        {
            ...
            if (this.Caster.HasModifier(musashi_modifier_battle_continuation_active.name))
            {
                this.AoeParticleStr = "particles/custom/musashi/musashi_tengen_no_hana_aoe_unique2.vpcf";
                this.AoeMarkerParticleStr = "particles/custom/musashi/musashi_tengen_no_hana_aoemarker_unique1.vpcf";
            }
        }
...
export class musashi_modifier_ganryuu_jima extends BaseModifier
{
    ...
    override OnDestroy(): void
    {
        ...
        this.Caster?.SetForwardVector(this.SecondSlashPosition);
        this.Caster?.StartGesture(GameActivity.DOTA_CAST_ABILITY_1);
        FindClearSpaceForUnit(this.Caster!, this.Caster?.GetAbsOrigin()!, true);
        this.Caster?.AddNewModifier(this.Caster, this.Ganryuu_Jima, "modifier_phase", {duration: 1});
    }
...
//======================================================================================================================
// Miyamoto Musashi: Skill 7: Tenma Gogan (SA)
//======================================================================================================================
@registerAbility()
...
{
    ParticleStr: string = "particles/custom/musashi/musashi_tenma_gogan_basic.vpcf";
    BodyParticleStr: string = "particles/custom/musashi/musashi_tenma_gogan_body.vpcf";
    ...
    override OnDestroy(): void
    {
        ...
        this.Caster?.AddNewModifier(this.Caster, this.Ability, musashi_modifier_tenma_gogan_debuff.name, {duration: DebuffDuration});
    }
    ...
    CreateParticle(): void
    {
        if (this.Caster?.HasModifier("modifier_ascended"))
        {
            this.ParticleStr = "particles/custom/musashi/musashi_tenma_gogan_unique.vpcf";
        }

        const ParticleId = ParticleManager.CreateParticle(this.ParticleStr, ParticleAttachment.POINT_FOLLOW, this.Caster);
        const BodyParticleId = ParticleManager.CreateParticle(this.BodyParticleStr, ParticleAttachment.POINT_FOLLOW, this.Caster);
        this.AddParticle(ParticleId, false, false, -1, false, false);
        this.AddParticle(BodyParticleId, false, false, -1, false, false);
    }
...
export class musashi_modifier_tenma_gogan_debuff extends BaseModifier
{
    ...
    override OnCreated(): void
    {
        ...
        this.Caster = this.GetCaster();
        giveUnitDataDrivenModifier(this.Caster!, this.Caster!, "pause_sealdisabled", 2);
    }
...
export class musashi_modifier_battle_continuation extends BaseModifier
{
    ...
    override OnTakeDamage(): void
    {
        ...
        if (this.Caster?.GetHealth()! <= 0 && this.Ability?.IsCooldownReady() && !this.Caster?.HasModifier(musashi_modifier_tenma_gogan_debuff.name))
        {
...
export class musashi_ishana_daitenshou extends BaseAbility
{
    ...
    Caster: CDOTA_BaseNPC | undefined;
    MarkLocation: Vector = Vector(0, 0, 0);

    override OnSpellStart(): void
    {
        this.Caster = this.GetCaster();
        this.MarkLocation = this.GetCursorTarget()?.GetAbsOrigin()!; 
        this.Caster.AddNewModifier(this.Caster, this, musashi_modifier_ishana_daitenshou.name, {duration: 5});
        this.PlaySound();
    }
...
{
    MarkerParticleStr: string = "particles/custom/musashi/musashi_ishana_daitenshou_marker_basic.vpcf";
    SwordParticle: string = "particles/custom/musashi/musashi_ishana_daitenshou_sword_basic.vpcf";
    BodyParticle: string = "particles/custom/musashi/musashi_ishana_daitenshou_body_basic.vpcf";
    ...
    CreateParticle(): void
    {
        if (this.Caster?.HasModifier("modifier_ascended"))
        {
            this.MarkerParticleStr = "particles/custom/musashi/musashi_ishana_daitenshou_marker_unique.vpcf";
            this.SwordParticle = "particles/custom/musashi/musashi_ishana_daitenshou_sword_unique.vpcf";
            this.BodyParticle = "particles/custom/musashi/musashi_ishana_daitenshou_body_unique.vpcf";
        }

        const MarkerParticleId = ParticleManager.CreateParticle(this.MarkerParticleStr, ParticleAttachment.WORLDORIGIN, this.Caster);
        const SwordParticleId = ParticleManager.CreateParticle(this.SwordParticle, ParticleAttachment.POINT_FOLLOW, this.Caster);
        const BodyParticleId = ParticleManager.CreateParticle(this.BodyParticle, ParticleAttachment.POINT_FOLLOW, this.Caster);
        ParticleManager.SetParticleControl(MarkerParticleId, 0, this.MarkerPosition);
        ParticleManager.SetParticleControlEnt(SwordParticleId, 0, this.Caster!, ParticleAttachment.POINT_FOLLOW, "attach_attack1",
                                              Vector(0, 0, 0), false);
        ParticleManager.SetParticleControlEnt(BodyParticleId, 0, this.Caster!, ParticleAttachment.POINT_FOLLOW, "attach_hitloc", 
                                              Vector(0, 0, 0), false);
        this.AddParticle(MarkerParticleId, false, false, -1, false, false);
        this.AddParticle(SwordParticleId, false, false, -1, false, false);
        this.AddParticle(BodyParticleId, false, false, -1, false, false);
    }
}

//======================================================================================================================
// Miyamoto Musashi: Skill 4: Niou (Innate)
//======================================================================================================================
@registerAbility()
