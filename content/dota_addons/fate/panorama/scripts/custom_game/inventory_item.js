...
function RightClickItem()
{
	...
	var bDropFromStash = bSlotInStash && bControllable;// && bDroppable;
...
function OnDragDrop( panelId, draggedPanel )
{
	...
	//draggedItem = the handle of item
	//m_ItemSlot = the inventory index 
	// create the order
	//$.Msg("Handle: " + draggedItem + ", m_ItemSlot: " + m_ItemSlot + ", ")
	var moveItemOrder =
	{
