...
function modifier_priestess_of_the_hunt:OnCreated()
    ...
    function hero:HasArrow(count)
        return modifier:GetStackCount() >= (count or 1)
    end
...
function modifier_priestess_of_the_hunt:GetModifierPreAttack_BonusDamage()
...
function modifier_priestess_of_the_hunt:GetMaxStackCount()
    ...
    return self:GetAbility():GetSpecialValueFor("arrows")
end
