...
function OnBarrageStart(keys)
    ...
    Timers:CreateTimer(function()
		...
		local spawn_location = targetPoint - (distance * caster:GetForwardVector()) + RandomVector(100)
...
function OnChainStart(keys)
	...
	caster:EmitSound("gilgamesh_enkidu_" .. math.random(1,2))
	enkiduTarget = target
