...
function OnRIStart(keys)
	...
	DoCleaveAttack(caster, target, ability, 0, 200, 400, 500, "particles/econ/items/sven/sven_ti7_sword/sven_ti7_sword_spell_great_cleave_gods_strength.vpcf")
...
function OnTripleCraneTarget(keys)
	...
	Timers:CreateTimer(0.3, function()
		if caster:IsAlive() and target:IsAlive() then 
			...
			UBWSword(ability,target,GetRotationPoint(targetloc,500,angle + 45),1)
			UBWSword(ability,target,GetRotationPoint(targetloc,500,angle + 135),1)
			UBWSword(ability,target,GetRotationPoint(targetloc,500,angle + 225),1)
			UBWSword(ability,target,GetRotationPoint(targetloc,500,angle + 315),1)
			...
			Timers:CreateTimer(0.4, function()
				...
				CreateSlashFx(caster, target:GetAbsOrigin() + Vector(100,-100,0) + Vector(200, 200, 0), target:GetAbsOrigin() + Vector(100,-100,0) + Vector(-200, -200, 0))
				CreateSlashFx(caster, target:GetAbsOrigin() + Vector(100,-100,0) + Vector(250, 250, 25), target:GetAbsOrigin() + Vector(100,-100,0) + Vector(-250, -250, 25))
				CreateSlashFx(caster, target:GetAbsOrigin() + Vector(100,-100,0) + Vector(300, 300, 50), target:GetAbsOrigin() + Vector(100,-100,0) + Vector(-300, -300, 50))
...
function OnTripleCraneWingStart (keys)
	...
	if keys.target ~= nil then 
		...
		Timers:CreateTimer(0.05, function()
			KBFireSword(lsword_origin, left_forward, ability, caster, speed, 1)
			KBFireSword(lsword_origin_2, left_forward_2, ability, caster, speed, 1)
			KBFireSword(rsword_origin, right_forward, ability, caster, speed, 2)
			KBFireSword(rsword_origin_2, right_forward_2, ability, caster, speed, 2)
