...
function BoardCreate(keys)
	...
	caster:SwapAbilities("fate_empty8", "drake_golden_hind_drive", false, true) 
	caster:SwapAbilities("fate_empty6", "drake_golden_hind_voyager_of_storm", false, true) 
	caster:SwapAbilities("fate_empty7", golden_wild_hunt, false, true) 
	...
	caster:FindAbilityByName(golden_wild_hunt):SetLevel(hero:FindAbilityByName(golden_wild_hunt):GetLevel())
	if not hero:FindAbilityByName(golden_wild_hunt):IsCooldownReady() then 
		caster:FindAbilityByName(golden_wild_hunt):StartCooldown(hero:FindAbilityByName(golden_wild_hunt):GetCooldownTimeRemaining())
	else
		if not caster:FindAbilityByName(golden_wild_hunt):IsCooldownReady() then 
			caster:FindAbilityByName(golden_wild_hunt):EndCooldown()
		end
	end
end
...
function GetOff (keys)
	...
	if not caster:FindAbilityByName(golden_wild_hunt):IsCooldownReady() then 
		hero:FindAbilityByName(golden_wild_hunt):StartCooldown(caster:FindAbilityByName(golden_wild_hunt):GetCooldownTimeRemaining())
	end
	caster:SwapAbilities("fate_empty8", "drake_golden_hind_drive", true, false) 
	caster:SwapAbilities("fate_empty6", "drake_golden_hind_voyager_of_storm", true, false) 
	caster:SwapAbilities("fate_empty7", golden_wild_hunt, true, false)
end
